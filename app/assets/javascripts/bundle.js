...
/***/ function(module, exports, __webpack_require__) {
	...
	var ItemButton = React.createClass({displayName: 'ItemButton',
	  render: function() {
	    var classNames = 'item-button ' + this.props.colour;
	    return (
	      React.createElement("div", {className: classNames, onClick: this.props.handleClick}, 
	        React.createElement("span", {className: "item-name"}, this.props.name.toUpperCase())
	      ));
	  }
	});
	...
	var Menu = React.createClass({displayName: 'Menu',
	  ...
	  render: function() {
	    ...
	    this.props.items.forEach(function(item, index) {
	      itemButtons.push(React.createElement(ItemButton, {name: item.name, price: '$'+(item.price_in_cents / 100.0), 
	...
	var SaleRow = React.createClass({displayName: 'SaleRow',
	  render: function() {
	    return (
	      React.createElement("div", {className: "sale-row"}, 
	        React.createElement("div", {className: "name"}, this.props.item.name), 
	        React.createElement("div", null, '$'+(this.props.item.price_in_cents / 100.0))
	      )
	    );
	  }
	});

	var Sale = React.createClass({displayName: 'Sale',
	  render: function() {
	    rows = [];
	    this.props.items.forEach(function(item) {
	      rows.push(React.createElement(SaleRow, {item: item}));
	    });

	    return (
	      React.createElement("div", {className: 'sale'}, 
	        React.createElement("div", {className: 'sale-items'}, 
	          rows
	        )
	      )
	    );
	  ...
	  render: function() {
	    return (
	      React.createElement("main", {id: "app"}, 
	        React.createElement(Menu, {items: ITEMS, onItemSelected: this.onItemSelected}), 
	        React.createElement(Sale, {items: this.state.selectedItems})
	      )
	    );
	  }
	});
